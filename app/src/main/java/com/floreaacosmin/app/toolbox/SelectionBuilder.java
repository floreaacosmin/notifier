...
public class SelectionBuilder {
    ...
    private static final String LOG_TAG = LogUtils.makeLogTag(SelectionBuilder.class);
    ...
    public Cursor query(SQLiteDatabase db, boolean distinct, String[] columns, String orderBy, String limit) {
        ...
        LogUtils.LOGD(LOG_TAG, "query(columns=" + Arrays.toString(columns) + ", distinct=" + distinct + ") " + this);
    ...
    public int update(SQLiteDatabase db, ContentValues values) {
        assertTable();
        LogUtils.LOGD(LOG_TAG, "update() " + this);
    ...
    public int delete(SQLiteDatabase db) {
        assertTable();
        LogUtils.LOGD(LOG_TAG, "delete() " + this);
