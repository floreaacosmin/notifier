...
public final class AppProviderURIContract {
	...
	public static final String BASE_PATH_DISTINCT_AUTHORS = "authors";
	...
	public static final Uri CONTENT_DISTINCT_AUTHORS_URI = Uri.parse(CONTENT_PREFIX + AUTHORITY + "/" + BASE_PATH_DISTINCT_AUTHORS);
